#Задание 2
#Выполнила Клышбекова Г.К. ПАЭ 124
#создайте модель множественной линейной регрессии дневных потоков паров воды за летний период 2013 года по данным измерений методом турбулетной пульсации
#зададим и проверим директорию 
setwd("D:/mathmod/Klyshbekova2") 
getwd()
